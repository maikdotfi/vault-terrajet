...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://releases.hashicorp.com/terraform-provider-vault/3.8.0
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-vault_v3.8.0_x4 #darwin_arm64
